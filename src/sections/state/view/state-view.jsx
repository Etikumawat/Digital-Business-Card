...
import { Cached, Delete, FilterList, Search } from '@mui/icons-material';
...
const headCells = [
  ...
  { id: 'country.name', numeric: false, disablePadding: true, label: 'Country' },
    ...
    <Box sx={{ width: '100%' }}>
      ...
      <Paper sx={{ width: '100%', mb: 2 }}>
        ...
        <TablePagination
          ...
          component="div"
          count={totalRows} // Update this to use totalRows state
